...
class CoqMCPServer {
  ...
  private async handleCoqInit(args: any) {
  ...
  private async handleCoqExec(args: any) {
  ...
  private async handleCoqCheck(args: any) {
  ...
  private async handleCoqGoals(args: any) {
  ...
  private async handleCoqSearch(args: any) {
  ...
  private async handleCoqPrint(args: any) {
  ...
  private async handleCoqUndo(args: any) {
  ...
  private async handleCoqReset(args: any) {
  ...
  private async handleCoqLoadFile(args: any) {
  ...
  private async handleCoqSaveFile(args: any) {
  ...
  private async handleCoqCompile(args: any) {
  ...
  private async handleCoqRequire(args: any) {
  ...
  private async handleCoqTactic(args: any) {
  ...
  private async handleCoqAdmit(args: any) {
  ...
  private async handleCoqAbort(args: any) {
  ...
  private async handleCoqInfo(args: any) {
  ...
  private async handleCoqExtract(args: any) {
  ...
  private async handleOpamList(args: any) {
  ...
  private async handleOpamInstall(args: any) {
  ...
  private async handleOpamSearch(args: any) {
  ...
  private async handleProjectBuild(args: any) {
  ...
  private async handleLtac2(args: any) {
  ...
  private async handleEquations(args: any) {
  ...
  private async handleMathComp(args: any) {
  ...
  private async handleHammer(args: any) {
  ...
  private async handleQuickChick(args: any) {
  ...
  private async handleFiatCrypto(args: any) {
  ...
  private async handleCompCert(args: any) {
  ...
  private async handleIris(args: any) {
  ...
  private async handleMetaCoq(args: any) {
  ...
  private async handleUniMath(args: any) {
  ...
  private async handleHoTT(args: any) {
  ...
  private async handleCoqEAL(args: any) {
  ...
  private async handleFlocq(args: any) {
  ...
  private async handleCoquelicot(args: any) {
  ...
  private async handleCoRN(args: any) {
